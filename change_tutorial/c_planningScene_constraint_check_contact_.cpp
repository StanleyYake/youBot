...
//    ros::init(argc, argv, "constraint_demo", ros::init_options::AnonymousName);
    ros::init(argc, argv, "youbot_moveit_planningScene_about_constraint_check_contact");
...
**************************************************/
       ...
       bool constraint_result2 = planning_scene.isStateConstrained(planning_scene.getCurrentState(), kinematic_constraint_set);
